...
class ViewController: UIViewController {
    ...
    @IBAction func pinchAction(sender: UIPinchGestureRecognizer) {
        if sender.state == .Began{
            ...
            redSquare.transform = CGAffineTransformMakeScale(scale, scale)
    ...
    override func viewDidLoad() {
        ...
        myPinchGestureRecognizer = UIPinchGestureRecognizer(target: self, action: #selector(ViewController.programPinch(_:)))

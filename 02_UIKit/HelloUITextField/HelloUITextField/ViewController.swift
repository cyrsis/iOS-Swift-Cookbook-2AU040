...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //產生flexible space
        let someSpace = UIBarButtonItem(barButtonSystemItem: .FlexibleSpace,
        ...
        //設定輸入完會呼叫的方法
        codeTextField.addTarget(self, action: #selector(ViewController.codeTextFieldEndEditing(_:)), forControlEvents: .EditingDidEndOnExit)
        //把文字輸入框加到畫面上
    ...
    func codeTextFieldEndEditing(textField:UITextField){
